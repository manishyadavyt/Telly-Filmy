 ...
 * Accessible at: https://tellyfilmy.com/uploads/filename.jpg
 *
 * Security: Protected by a secret key set in UPLOAD_SECRET below.
 * Change UPLOAD_SECRET to a strong random string.
 */

// ─── CONFIG ────────────────────────────────────────────────────────────────
define('UPLOAD_SECRET', 'tellyfilmy_upload_2024');   // ← Change this to a secret key
...
// CORS headers — allows admin panel (same domain) to POST here
...
$slug     = $slug ?: 'image';
$type     = in_array($_POST['imageType'] ?? '', ['main', 'article']) ? $_POST['imageType'] : 'img';
